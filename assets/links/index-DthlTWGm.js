...
`,links:[{name:"114514",content:"1919810",type:"text"}]}]},{title:"Test2",items:[{name:"Test1919810",img:"f7--number.png",description:"Test",links:null}]}]};b(u);const v=f(),c=x[v],p=i(".container"),$=i(".link-detail"),a=i(".link-detail > .v-box");w();function w(){c!==null&&c.forEach(t=>{p.append(`<h1>${t.title}</h1>`);let n=i("<div></div>");t.items&&t.items.forEach(e=>{let s=i(`
    ...
    `),t.links&&t.links.forEach(n=>{let e=i(`<div class="h-box"><mdui-text-field variant="outlined" readonly label="${n.name}" value="${n.type==="url"?n.content.replace(/^(https?:\/\/)/,""):n.content}"></mdui-text-field></div>`);if(n.type==="url")e.append(`<mdui-button-icon href="${n.content}" target="_blank"><mdui-icon-open-in-new></mdui-icon-open-in-new></mdui-button-icon>`);else{let s=i("<mdui-button-icon><mdui-icon-content-copy></mdui-icon-content-copy></mdui-button-icon>");s.on("click",()=>{navigator.clipboard.writeText(n.content),y({message:u[v]._other.copied_snackbar_msg,autoCloseDelay:500})}),e.append(s)}a.append(e)}),t.description&&a.append(`<p>${t.description}</p>`),$.attr("open","")}
